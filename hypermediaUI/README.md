...
Lot of errors: 
    ...
    ./src/Components/Projects.js
      Line 29:  React.PropTypes is deprecated since React 15.5.0, use the npm module prop-types instead  react/no-deprecated
      Line 30:  React.PropTypes is deprecated since React 15.5.0, use the npm module prop-types instead  react/no-deprecated

to solve: 

1. `npm install --save prop-types`  this add `"prop-types": "^15.6.0",` to package json
2. Add `import PropTypes from 'prop-types';` to all files with errors
3. Remove React from `project: React.PropTypes.object,`
4. run `yarn start`   
